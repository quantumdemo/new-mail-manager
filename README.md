...
3.  **Configure OAuth Consent Screen**:
    ...
    - Add the scope: `.../auth/gmail.modify` (or `.../auth/gmail.readonly` for analysis only).
...
- **Environment Variables**: Set `FLASK_SECRET_KEY`, `GOOGLE_CLIENT_ID`, `GOOGLE_CLIENT_SECRET`, and `FRONTEND_URL` (your Netlify URL).

### Frontend (Netlify)
- **Build Command**: `npm run build`
- **Publish Directory**: `frontend/dist`
- **Environment Variables**: Set `VITE_API_URL` to your Render backend URL.
- **SPA Routing**: The `frontend/public/_redirects` file is already included.
